...
def start_video():
    ...
    with hands_module.Hands(static_image_mode=False, min_detection_confidence=0.7,
        ...
        while round_counter < 7:
            ...
            score_text = f"Player: {player_score} | Computer: {computer_score}"  # Display scores
            cv2.putText(frame, score_text, (10, 50), font, 1, (255, 255, 255), 2, cv2.LINE_4)
    ...
    if player_score > computer_score:
        ...
        speak("Congratulations! You've won the game.")
    elif player_score < computer_score:
        print("You've lost the game. Better luck next time.")
        speak("You've lost the game. Better luck next time.")
    else:
        print("It's a tie. The game ends in a draw.")
        speak("It's a tie. The game ends in a draw.")
